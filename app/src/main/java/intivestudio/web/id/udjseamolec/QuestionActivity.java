...
/**
 * Created by Krisnasw on 7/4/2016.
 */
...
public class QuestionActivity extends Activity {
    ...
    private void showQuestion(int qIndex,boolean review) {
        try {
            ...
            if (correctAns[qIndex] == -1) {
                String correctAnsStr = aQues.getString("correct_answer");
            ...
            JSONArray ansList = aQues.getJSONArray("quiz_questions");
            String aAns = ansList.getJSONObject(0).getString("pila");
            answer1.setText(aAns.toCharArray(), 0, aAns.length());
            aAns = ansList.getJSONObject(1).getString("pilb");
            answer2.setText(aAns.toCharArray(), 0, aAns.length());
            aAns = ansList.getJSONObject(2).getString("pilc");
            answer3.setText(aAns.toCharArray(), 0, aAns.length());
            aAns = ansList.getJSONObject(3).getString("pild");
    ...
    private void setScoreTitle() {
        this.setTitle("UDJ Seamolec" + (quesIndex+1)+ "/" + QuizFunActivity.getQuesList().length());
    }
